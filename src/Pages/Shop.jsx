    ...
    <div>
      ...
      >
        <section id="page-shop">
          <h2>STAY HOME</h2>
          <div className="marquee" style={{ backgroundColor: "transparent", width: "30%" }}>
      ...
      <section id="product1" className="section-p1">
        <div className="pro-con flex flex-wrap justify-center gap-6">
          {Product1s.map(product1 => (
            ...
            >
              <img src={product1.image} alt={product1.title} height={290} />
              <div className="des">
                ...
                <Link
                  to={product1.cartLink}
                  onClick={e => e.stopPropagation()}
                  aria-label={`Add ${product1.title} to cart`}
                >
